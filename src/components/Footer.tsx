...
const navigation = {
  ...
  social: [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/wharton-eclub/',
      icon: (props: any) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/whartoneclub/',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <Container className="pb-8 pt-16">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-sm leading-6 text-gray-300">
              <div className="max-w-[200px]">
                ...
                <a href="mailto:northc@wharton.upenn.edu" className="block hover:text-[#9eff65] truncate">
        ...
        <div className="mt-8 border-t border-white/10 pt-8">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} Wharton Entrepreneurship Club. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
