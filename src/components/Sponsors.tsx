...
export function Sponsors({ onHomePage = false }: SponsorsProps) {
  ...
  return (
    <section className="relative min-h-screen bg-white">
      {/* Header Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-950 to-blue-950 py-32 min-h-screen grid place-items-center">
        <Container className="relative">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-8">
              ...
              <div className="grid sm:grid-cols-4 gap-8 max-w-4xl mx-auto mb-12">
                <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                  <div className="text-4xl font-bold text-white mb-2">250+</div>
                  <div className="text-gray-300">Student Attendees</div>
                </div>
                <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                  <div className="text-4xl font-bold text-white mb-2">40+</div>
                  <div className="text-gray-300">Founders & VCs</div>
                </div>
                <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                  <div className="text-4xl font-bold text-white mb-2">5</div>
                  <div className="text-gray-300">Days of Impact</div>
                </div>
                <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                  <div className="text-4xl font-bold text-white mb-2">2</div>
                  <div className="text-gray-300">Premier Venues</div>
                </div>
              </div>
      ...
      <Container className="py-16">
        ...
        <div className="mb-16 max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Sponsorship Opportunities</h2>
          <div className="space-y-8">
            {sponsorshipTiers.reverse().map((tier) => (
              <div
                key={tier.name}
                className={clsx(
                  "relative rounded-2xl p-8 transition-all duration-200 hover:shadow-lg border",
        ...
        <div>
          ...
          <LogoMarquee className="bg-gray-50 py-12 rounded-2xl" whiteLogos={false} />
        </div>
      </Container>
    </section>
  )
